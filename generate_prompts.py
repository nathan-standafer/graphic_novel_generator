...
def generate_prompt_for_scene(scene_text, character_list, chapter_context=None, model_name="openai/gpt-oss-20b", retries=3, backoff_factor=0.5):
    ...
    system_prompt = (
        ...
        "Your task is to generate vivid, detailed image prompts based on specific scenes from a chapter of the The Odyssey by Homer. "
        ...
        "The desired art style should be consistent with classic greek mythology. The images should not be be realistic and not cartoonish. "
